...
import { onAuthChanged } from "@/modules/auth";

const router = useRouter();
onAuthChanged((user) => router.push(user ? "/wallet/home" : "/login"));
...
<template>
  <div class="min-h-screen bg-gray-800 overflow-hidden">
        ...
        <nav class="relative max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6" aria-label="Global">
          <div class="flex items-center flex-1">
            ...
            <div class="hidden space-x-10 md:flex md:ml-10">
              <a v-for="nav in navigations" :key="nav.name" :href="nav.href" class="font-medium text-white hover:text-gray-300">{{ nav.name }}</a>
            </div>
          </div>
            ...
            <div class="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
              <div>
                ...
                <h1 class="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:leading-none lg:mt-6 lg:text-5xl xl:text-6xl">
                  <span class="md:block">Your digital wallet</span>
                  {{ " " }}
                  <span class="text-indigo-400 md:block">in one-click</span>
                </h1>
