...
<template>
  <div class="pb-4">
    <div class="font-body text-sm mb-4 text-app-text-600 dark:text-app-text-dark-500">
      Torus collects anonymous data about any crashes that occur to help improve our products and services.
    </div>
    <div class="flex items-center">
      ...
      <div class="font-body text-app-text-500 dark:text-app-text-dark-500 text-sm">Crash report was enabled</div>
    </div>
  </div>
</template>
