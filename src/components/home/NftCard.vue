...
<template>
  <div @click="cardClicked" @keydown="cardClicked">
    <div class="large-card cursor-pointer bg-white dark:bg-app-gray-700 rounded-lg shadow-md dark:shadow-dark overflow-hidden m-4">
...
<style scoped>
.token-name {
  @apply font-bold text-base leading-5 text-gray-800 break-all dark:text-app-text-dark-white truncate;
}
