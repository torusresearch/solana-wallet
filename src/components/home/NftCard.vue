...
<template>
  <div
    ...
    @keydown="cardClicked"
  >
    <div v-if="props.summaryData && mode === NFT_CARD_MODE.SUMMARY" class="summary-card">
      <div class="nft-item flex flex-row justify-start items-center overflow-hidden max-w-full">
    ...
    <div v-if="mode !== NFT_CARD_MODE.SUMMARY && nftToken" class="large-card">
      <div class="nft-item flex flex-col justify-start">
