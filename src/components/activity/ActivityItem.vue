...
const getLogoUrl = (cryptoCurrency: string) => {
  if (cryptoCurrency) return SolanaLogoURL;
  return SolanaLogoURL;
};
</script>
<template>
  <div
    ...
    <div class="col-span-6 order-1 sm:order-2 pl-0 sm:pl-6">
      <div class="flex">
        <div class="flex items-center justify-center logo-container">
          <img class="block h-7 w-auto" :src="getLogoUrl(activity.cryptoCurrency || '')" alt="Solana Logo" />
        </div>
