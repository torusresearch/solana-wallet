...
<template>
  <div
    ...
    class="w-full h-full overflow-hidden text-left align-middle transition-all transform bg-white dark:bg-app-gray-800 shadow-xl flex flex-col justify-center items-center"
  >
    <div class="content-box w-full h-full transition-all bg-white dark:bg-app-gray-800 shadow-xl flex flex-col relative">
      ...
      <div class="mt-4 px-6 items-center px-4 flex flex-col justify-start items-start w-full">
