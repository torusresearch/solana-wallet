...
<template>
  <div
    class="w-full h-full overflow-hidden text-left align-middle transition-all bg-white dark:bg-app-gray-600 shadow-xl flex flex-col justify-center items-center"
  >
